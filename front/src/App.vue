        ...
        <div class="task-list">
          <table>
            ...
            <tbody>
              <tr>
                <td>
                  <button class="btnicons"><img class="icone"
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-body">
                ...
                <form @submit.prevent="cadastra($event)">
                  <div class="conatiner-body ">
                    <div id="container-inputs">
                      <label>Nome <br /><input v-model="nometarefa" type="text" name="nometarefa" id="nometarefa"></label>
                      <label>Custo R$ <br /><input v-model="custo" type="number" name="custo" id="custo"></label>
                      <label>Data Limite <br /><input v-model="datalimite" type="date" name="datalimite" id="datalimite"></label>
                    </div>
                  </div>

                  <button type="button" class="btincluir">Incluir</button>
